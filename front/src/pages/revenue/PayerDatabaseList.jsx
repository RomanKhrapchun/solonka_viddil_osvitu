...
const PayerDatabaseList = () => {
    ...
    const { error, status, data, retryFetch } = useFetch('api/revenue/payer-database/filter', {
        method: 'post',
        data: state.sendData
    });
    ...
    const handleView = useCallback((id) => {
        navigate(`/revenue/payer-database/${id}`);
    }, [navigate]);

    const handleAdd = useCallback(() => {
        navigate('/revenue/payer-database/create');
    }, [navigate]);
...
export default PayerDatabaseList;
